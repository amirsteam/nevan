...
// ==================== PRODUCTS ====================
router.get('/products', paginationValidator, asyncHandler(async (req: Request, res: Response) => {
...
router.post('/categories/:id/image', mongoIdValidator('id'), uploadCategoryImage.single('image'), asyncHandler(async (req: any, res: Response) => {
...
// ==================== USERS ====================
router.get('/users', paginationValidator, asyncHandler(async (req: Request, res: Response) => {
...
router.put('/users/:id/status', mongoIdValidator('id'), asyncHandler(async (req: Request, res: Response) => {
...
router.put('/users/:id/role', mongoIdValidator('id'), asyncHandler(async (req: Request, res: Response) => {
    const { role } = req.body;
